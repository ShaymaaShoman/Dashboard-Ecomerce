export function Footer() {
  return (
    <footer className="border-t bg-white text-sm text-slate-500 card">
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Powerful admin dashboard to manage products, orders and customers
              with ease.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li><a href="/" className="footer-link">Revenue</a></li>
                <li><a href="/" className="footer-link">Reports</a></li>
              </ul>
            </div>
        ...
        {/* Bottom */}
        <div className="flex flex-col justify-between pt-5 pb-8 border-t sm:flex-row">
